...
a'8-4 \f[g-3 f-2] r4. | g8-4[f-3 e-2] | r4.| e8-3[f e] | r4. | d8-4[c b] | r4. |
a'8-4 \f[g f] | r4. | g8-4[f e]| r4. | e8-3[f e] | r4. | d8-4[c b]| r4.

  }}
 \new Staff {\clef violin \easyHeadsOn
\relative c' {
r4. | e8-5 \p [gis-3 b-1] | r4. | a8-3 r8 r8 | r4. | e8-5 [gis b] |r4.| a4-3 a8 |
